...
export class Projects {
  projects: Project[] = [
    ...
    {
      name: 'DucklordChatking',
      description: 'Ducklord, Chatking is a playful chat client for communicating with friends. It blends a game-like UI with real-time messaging so conversations feel fun and fluid.',
      url: 'https://github.com/LeafMaster1/DucklordChatking',
      language: ['C#', 'Raylib_cs','ASP.NET  / Scalar'],
      images: [
        'assets/DuckLord-ChatKing/Ducklord-ChatKing.jpeg',
        'assets/DuckLord-ChatKing/inloggning.png',
        'assets/DuckLord-ChatKing/Create-duck.png',
        'assets/DuckLord-ChatKing/homeScreen.png',
        'assets/DuckLord-ChatKing/options.png',
        'assets/DuckLord-ChatKing/message.png',
        'assets/DuckLord-ChatKing/message-test.png',
      ]
    },
  ];
